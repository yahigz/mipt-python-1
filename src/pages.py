...
class Menu:
    ...
    def __init__(self, ex_data):
        self.exercise_data = ex_data
        self.root = tk.Tk()
    ...
    def to_keyboard_exercise(self):
        self.root.destroy()
        current_section = KeyboardExercise(self.exercise_data)
    ...
    def upload_from_file(self):
        ...
        with open(filepath, "r") as file:
            ...
            self.exercise_data.add(current)

    def to_upload_manually(self):
        self.root.destroy()
        current_section = UploadExerciseManually(self.exercise_data)
...
class KeyboardExercise:
    ...
    def __init__(self, ex_data):
        ...
        self.current_exercise = self.exercise_data.pick()
...
class UploadExerciseManually:
    ...
    def add_manually(self):
        self.exercise_data.add(Exercise(self.Input.get().split()))
        self.to_menu()
